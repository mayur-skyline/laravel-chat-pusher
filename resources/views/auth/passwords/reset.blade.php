            ...
            <div class="card border border-light-subtle rounded-3 shadow-sm">
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="col-12">
                        ...
                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required placeholder="name@example.com" autocomplete="email" autofocus>
                    ...
                    <div class="col-12">
                        <div class="form-floating mb-3">
                        <input type="password" class="form-control" name="password_confirmation" id="new-password" required autocomplete="new-password" placeholder="Password" required>
                        <label for="new-password" class="form-label">{{ __('Confirm Password') }}</label>
                        </div>
                    </div>
                    <div class="col-12">
